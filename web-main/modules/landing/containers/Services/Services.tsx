...
export const Services = () => {
  ...
  subHeading="Discover the range of professional services we offer to help you achieve your goals. From expert support to tailored solutions, we’re here to deliver value and results."
/>
